...
The PoC implements both physical memory reads and writes. Currently, transfers are limited to 512 bytes at a time, but larger multi-block transfers are already working and will be published soon. I also plan to support dumping to specific file clusters to make dump navigation easier.
...
This is what the screen looks like after running the read and write commands:
![output](output.png)
